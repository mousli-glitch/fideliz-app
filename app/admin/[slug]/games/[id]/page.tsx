...
export default function EditGamePage() {
    ...
    const loadGame = async () => {
        ...
        if (game) {
            ...
            setDesignData({
                ...
                wheel_color_1: game.wheel_color_1 || '#2563EB',
                wheel_color_2: game.wheel_color_2 || '#0F172A',
                overlay_style: game.overlay_style || 'dark'
            })
  ...
  <div className="mt-3 p-3 rounded-xl border border-amber-200 bg-amber-50">
    <p className="text-[11px] font-bold text-amber-900">
      ⚠️ Modifier ce logo l’appliquera à <span className="font-black">tous</span> les jeux de ce restaurant.
    </p>
