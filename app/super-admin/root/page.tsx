...
import {
  ...
  Terminal, ChevronRight, DollarSign
} from 'lucide-react'
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        ...
        () => {
          // on recharge depuis la source de vérité server action
          loadData()
        }
      )
      .subscribe()
                  ...
                  <div key={log.id} className="group">
                    <div
                      ...
                      className={`
                        ...
                        ${log.level === 'error' || log.level === 'critical' || log.action_type?.includes('BLOCKED')
