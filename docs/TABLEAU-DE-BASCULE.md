...
| 7d — `is_active` dans les prédicats | à faire | 086. Sans elle, la coupure n'est que du confort d'interface |
...
| **R4** | Migrateur rejouable et idempotent | Sur banc neuf : deux exécutions consécutives donnent des empreintes de contenu **identiques** ; un arrêt au milieu se reprend sans doublon |
...
## 6. Ce qui n'a jamais été touché, et qu'il faudra ouvrir
